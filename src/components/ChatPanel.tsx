...
export function ChatPanel({
  ...
  return (
    <div className="fixed z-10 inset-x-0 bg-white/90 bottom-0 w-full duration-300 ease-in-out peer-[[data-state=open]]:group-[]:lg:pl-[250px] peer-[[data-state=open]]:group-[]:xl:pl-[300px] dark:from-10%">
      ...
      <div className="mx-auto sm:max-w-2xl sm:px-4">
        ...
        <div className="grid gap-4 sm:pb-4">
          <ChatForm input={input} setInput={setInput} />
